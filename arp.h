...
public:
    ...
    //starts an
    static ArpThread * startAprThread(wxString ipstr, pcap_if_t* interf, wxTextCtrl* output, bool * send);

    wxThreadError Create(bool * send_, pcap_if_t* interf_, const u_char ethSrcMac[], const u_char ethDstMac[], const u_char srcIP[], const u_char dstIP[]) {
